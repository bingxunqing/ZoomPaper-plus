    ...
    <aside className="flex w-[286px] shrink-0 flex-col border-l border-zp-border bg-[#fbfbfa] dark:bg-[#191919]">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-5">
        ...
        <div className="mt-4 flex items-center gap-1">
          ...
          <IconTooltip label={paper.starred ? "取消星标" : "添加星标"}><button type="button" onClick={onToggleStar} aria-label={paper.starred ? "取消星标" : "添加星标"} className={cn("flex h-8 w-8 items-center justify-center rounded-md hover:bg-zp-surface-hover", paper.starred ? "text-amber-500" : "text-zp-quaternary")}><Star className={cn("h-4 w-4", paper.starred && "fill-current")} /></button></IconTooltip>
